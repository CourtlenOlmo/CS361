...
def server_main():
    ...
    while True:
        ...
        genre = request.decode()
        print(f">>> Received request from the client: '{genre}'...")
        ...
        results = perform_google_search(genre)
...
def perform_google_search(query: str) -> list[str]:
    ...
    search_query = f"{query} best sellers amazon"
    all_results = []
